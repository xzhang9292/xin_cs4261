...
public class BusinessProjectDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String decriptionData = "Hello world jhjdflkhflkhjdfkljdhsfldfhdlfjsldfhdlfhsdlfhjsdfdjkh";
...
//        drf = FirebaseDatabase.getInstance().getReference().child("projects").child(pid).child("description");
...
//        });
    ...
    class GetDataTask extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialog = new ProgressDialog(BusinessProjectDetail.this);
